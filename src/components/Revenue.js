...
export default function Revenue() {
  ...
  useEffect(() => {
    const targetRevenue = 1876594; // Specify your target revenue value here
    const targetClientsHelped = 7; // Specify your target clients helped value here
    const targetTotalAdSpend = 2; // Specify your target total AD spend value here
    ...
    <div>
      <div className="Revenue" id="Revenue">
        ...
        <div className="Revenue-Card">
          ...
          <div className="Card">
            <span id="Card-Text-1">{totalAdSpend}+</span>
            <span id="Card-Text-2">Years Experience</span>
          </div>
          <div className="Card">
